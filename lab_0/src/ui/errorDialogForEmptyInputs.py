...
# Form implementation generated from reading ui file 'errorDialogForEmptyInputs.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_2.setGeometry(QtCore.QRect(100, 60, 201, 16))
        font = QtGui.QFont()
        font.setFamily("Avenir")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label.setText(_translate("Dialog", "Произошла ошибка!"))
        self.label_2.setText(_translate("Dialog", "Пожалуйста, заполните все поля."))
